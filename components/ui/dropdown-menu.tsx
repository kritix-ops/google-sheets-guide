...
// Plain styled div — base-ui's `Menu.GroupLabel` requires a `<Menu.Group>`
// parent and throws `MenuGroupRootContext is missing` when used standalone.
// shadcn semantics treat the label as a freestanding element; matching that.
